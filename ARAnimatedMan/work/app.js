...
const MODEL_FBX_URL = '../assets/Samba_Dancing.fbx';
...
class App {
  ...
  async onSessionStarted(session) {
	...
	loader.load(MODEL_FBX_URL, function ( object ) {
        MainModel = object;
        ...
        //object.scale.set(MODEL_SCALE/100, MODEL_SCALE/100, MODEL_SCALE/100);
  ...
  async onClick(e) {
    ...
    if (hits.length) {
      ...
      MainModel.scale.set(MODEL_SCALE/50, MODEL_SCALE/50, MODEL_SCALE/50);
      MainModel.position.set(this.model.position.x, this.model.position.y, this.model.position.z);
      this.model.scale.set(MODEL_SCALE/5000, MODEL_SCALE/5000, MODEL_SCALE/5000);
